...
(function () {
    ...
    function Ue(e) {
        for (var r = 1; r < arguments.length; r++) {
            ...
            typeof Object.getOwnPropertySymbols == "function" &&
                (i = i.concat(
                    Object.getOwnPropertySymbols(t).filter(function (f) {
    ...
    function gt(e, r) {
        ...
        if (t != null) {
            var i = [],
                ...
                v;
            try {
                for (t = t.call(e); !(f = (g = t.next()).done) && (i.push(g.value), !(r && i.length === r)); f = true);
            } catch (y) {
                (s = true), (v = y);
            } finally {
                try {
    ...
    function Be(e) {
        return e === undefined ? true : typeof e == "string" && tr.test(e);
    }
    var rr = /^[a-z0-9_\-=]{0,255}$/i;
    function je(e) {
        return e === undefined ? true : typeof e == "string" && rr.test(e);
    }
    function Ge(e) {
    ...
    var Ft = (function (e) {
        ...
        function t(i, f) {
            Lt(this, t);
            var s;
            return (s = r.call(this, i)), xe(Se(s), "code", undefined), (s.name = "TurnstileError"), (s.code = f), s;
        }
        return t;
    })(Ie(Error));
    function m(e, r) {
    ...
    function Je() {
        ...
        for (var t = document.querySelectorAll("script"), i = 0, f; (f = t[i]); i++) if (k(f, HTMLScriptElement) && e.test(f.src)) return f;
    }
    function Wt() {
        var e = Je();
        ...
        (e.async || e.defer) && (r.loadedAsync = true);
        var t = e.src,
            i = t.split("?");
    ...
    function or(e, r) {
        ...
        var t = true,
            ...
            f = undefined;
        try {
            for (var s = e.widgetMap[Symbol.iterator](), g; !(t = (g = s.next()).done); t = true) {
                var v = be(g.value, 2),
                    y = v[0],
                    u = v[1],
                    b;
                ...
                var T = X(y);
                if (!T) {
                    u.watchcat.missingWidgetWarning || (x("Cannot find Widget ".concat(T, ", consider using turnstile.remove() to clean up a widget.")), (u.watchcat.missingWidgetWarning = true));
                    continue;
                }
                ...
                if ((u.isExecuting || !u.isInitialized || (u.isInitialized && !u.isStale && !u.isExecuted)) && u.watchcat.lastAckedSeq !== 0 && u.watchcat.lastAckedSeq < u.watchcat.seq - 1 - ir) {
                    var R;
                    (u.watchcat.lastAckedSeq = 0), (u.watchcat.seq = 0), (u.isExecuting = false), console.log("Turnstile Widget seem to have crashed: ", y);
                    var d;
                    if (
                        ((R = e.msgHandler) === null ||
                            R === undefined ||
                            R.call(e, {
                                data: {
                                    ...
                                    code: we,
                                    event: "fail",
                                    rcV: (d = u.rcV) !== null && d !== undefined ? d : W,
                                },
                            }),
                        r)
                    ) {
                        ...
                        window.postMessage(
                            {
                                ...
                                widgetId: y,
                                event: "rcv-update",
                                rcV: (o = u.rcV) !== null && o !== undefined ? o : W,
                            },
                            "*"
                        );
                    }
    ...
    function rt(e, r) {
        ...
        if (r) {
            var i;
            t = (i = e["base-url"]) !== null && i !== undefined ? i : t;
        }
        return t;
    }
    ...
    function zt(e, r) {
        ...
        var i = Je();
        if (!(!i || !i.parentNode)) {
            var f = i == null ? undefined : i.nonce;
            e._pState = r;
            var s = new URL(i.src),
                g = document.createElement("script");
            s.searchParams.set("_upgrade", "true"), s.searchParams.set("_cb", String(Date.now())), (g.async = true), f && (g.nonce = f), g.setAttribute("crossorigin", "anonymous"), (g.src = s.toString()), i == null || (t = i.parentNode) === null || t === undefined || t.replaceChild(g, i);
        }
    }
    function Ht(e, r) {
        var t = e._pState;
        return t ? ((r.isReady = t.isReady), (r.isRecaptchaCompatibilityMode = t.isRecaptchaCompatibilityMode), (r.lastWidgetIdx = t.lastWidgetIdx), (r.scriptWasLoadedAsync = t.scriptWasLoadedAsync), (r.upgradeAttempts = t.upgradeAttempts), (r.upgradeCount = t.upgradeCount + 1), (r.watchCatInterval = null), (r.watchCatSeq = t.watchCatSeq), (r.widgetMap = t.widgetMap), true) : false;
    }
    var at = function (e) {
    ...
    function qt(e, r, t) {
        for (
            var i = "",
                f = 0,
                s = document.createNodeIterator(e, NodeFilter.SHOW_ELEMENT | NodeFilter.SHOW_TEXT, {
    ...
    function ut() {
        var e = [wt, Tt];
        _.isRecaptchaCompatibilityMode && e.push(St),
            document.querySelectorAll(e.join(", ")).forEach(function (r) {
                return st.render(r);
            });
    }
    var lt = [];
    function jt() {
        ...
        var e = true,
            ...
            t = undefined;
        try {
            for (var i = lt[Symbol.iterator](), f; !(e = (f = i.next()).done); e = true) {
                var s = f.value;
                s();
            }
        } catch (g) {
    ...
    function cr(e, r) {
        ...
        (u.style.position = "absolute"),
            (u.style.width = "26px"),
            (u.style.height = "26px"),
            (u.style.zIndex = "21474836421"),
            (u.style.cursor = "pointer"),
            (u.style.right = "2px"),
            (u.style.top = "5px"),
            u.setAttribute("width", "26"),
            u.setAttribute("height", "26"),
            u.addEventListener("click", function () {
                var R;
                (R = g.parentNode) === null || R === undefined || R.removeChild(g);
            });
        ...
        S.setAttribute("stroke-width", "3"), S.setAttribute("stroke", "#fff"), S.setAttribute("fill", "none"), S.setAttribute("x1", "6"), S.setAttribute("x2", "18"), S.setAttribute("y1", "5"), S.setAttribute("y2", "18"), u.appendChild(S), v.appendChild(y), v.appendChild(u), g.appendChild(v), (t = s.parentNode) === null || t === undefined || t.appendChild(g);
    }
    function Qt(e, r) {
    ...
    function lr(e) {
        return e.origin ? e.origin === "https://challenges.cloudflare.com" || e.origin === "https://challenges-staging.cloudflare.com" : true;
    }
    function sr(e) {
    ...
    function Xt() {
        ...
        return e == null ? undefined : e.location.href;
    }
    var st = (function () {
        function e(d, o, n, c) {
        ...
        function r() {
            return (
                (r = vt(function (d, o, n, c) {
                    var a, p, h, l, w, E, O, C, M, q;
                    return Ee(this, function (I) {
                        switch (I.label) {
                            case 0:
                                if (((a = d.params.sitekey), (p = Xt()), !p)) return x("Cannot determine Turnstile's embedded location, aborting clearance redemption."), i(d, o, false), [2];
                                (h = "h/".concat("b", "/")), (l = new URL(p)), (w = "https"), (E = ""), (O = "".concat(w, "://").concat(l.host, "/cdn-cgi/challenge-platform/").concat(h, "rc/").concat(c).concat(E)), (I.label = 1);
                            case 1:
                                return (
                                    I.trys.push([1, 6, , 7]),
                                    [
                            ...
                            case 2:
                                return (C = I.sent()), C.status === 200 ? [3, 3] : (x("Cannot determine Turnstile's embedded location, aborting clearance redemption."), i(d, o, false), [3, 5]);
                            case 3:
                                return [4, C.json()];
                            case 4:
                                if (((M = I.sent()), "status" in M && M.status === "redeemed")) return i(d, o, true), [2];
                                I.label = 5;
                            case 5:
                                return [3, 7];
                            case 6:
                                return (q = I.sent()), x("Error contacting Turnstile, aborting clearance remdeption."), i(d, o, false), [3, 7];
                            case 7:
                                return [2];
                        }
                    });
        ...
        function t(d, o, n) {
            if (d.params.retry === se.AUTO || n) {
                d.isExecuted && (d.msgQueue.push(K.EXECUTE), (d.isExecuted = true), (d.isExecuting = true));
                var c,
                    a = n ? 0 : 2000 + ((c = d.params["retry-interval"]) !== null && c !== undefined ? c : 0);
        ...
        function i(d, o, n) {
            ...
            (d.isExecuting = false), Qt(o, d.response);
            var c = d.cbSuccess;
            c && c(d.response, n);
        }
        function f(d) {
                ...
                if (!(!n.widgetId || !_.widgetMap.has(n.widgetId))) {
                    ...
                    if (!(!c || !a))
                        switch (n.event) {
                            ...
                            case "complete": {
                                (a.rcV = W), (a.response = n.token), n.sToken ? e(a, c, n.sToken, n.chlId) : i(a, c, false);
                                break;
                            }
                            case "fail": {
                                n.rcV && (a.rcV = n.rcV), n.cfChlOut && (a.cfChlOut = n.cfChlOut), n.cfChlOutS && (a.cfChlOutS = n.cfChlOutS), n.code && (a.errorCode = n.code), (a.isExecuting = false), (a.isInitialized = true), it(c);
                                var M = a.cbError,
                                    q = n.code === we;
                                if (M) {
                                    var I;
                                    M(String((I = n.code) !== null && I !== undefined ? I : ht)) || (n.code && x("Error: ".concat(n.code)), t(a, c, q));
                                } else n.code ? (t(a, c, q), m("Error: ".concat(n.code), 3076)) : t(a, c, false);
                                break;
                            }
                            case "feedbackInit": {
                                cr(c, a);
                            ...
                            case "requestFeedbackData": {
                                var Y,
                                    Z = document.querySelector("#".concat(c));
                                if (!Z) {
                                    m("Received state for an unknown widget: ".concat(n.widgetId), 3078);
                                    return;
                                }
                                (Y = Z.contentWindow) === null ||
                                    Y === undefined ||
                                    Y.postMessage(
                                        {
                                            source: P,
                            ...
                            case "turnstileResults": {
                                var Q,
                                    ee = document.querySelector("#".concat(c, "-fr"));
                                if (!ee) {
                                    m("Received state for an unknown widget: ".concat(n.widgetId), 3078);
                                    return;
                                }
                                (Q = ee.contentWindow) === null ||
                                    Q === undefined ||
                                    Q.postMessage(
                                        {
                                            source: P,
                            ...
                            case "closeFeedbackReportIframe": {
                                var ce,
                                    ue,
                                    pe = document.querySelector("#".concat(c, "-fr"));
                                if (!pe) {
                                    m("Received state for an unknown widget: ".concat(n.widgetId), 3078);
                                    return;
                                }
                                (ue = pe.parentElement) === null || ue === undefined || (ce = ue.parentElement) === null || ce === undefined || ce.remove();
                                break;
                            }
                            case "tokenExpired": {
                                var Ne = n.token;
                            ...
                            case "requestExtraParams": {
                                var N,
                                    D = document.querySelector("#".concat(c));
                                if (!D) {
                                    m("Received state for an unknown widget: ".concat(n.widgetId), 3078);
                                    return;
                                }
        ...
        function u(d, o) {
            if (o) {
                var n = ["retry-interval", "retry", "size", "theme", "tabindex", "execution", "refresh-expired", "response-field-name", "response-field", "language", "base-url", "appearance", "sitekey"],
                    ...
                    h = undefined;
                try {
                    for (var l = n[Symbol.iterator](), w; !(a = (w = l.next()).done); a = true) {
                        var E = w.value;
        ...
        function b(d) {
            ...
            if (n) {
                (n.isResetting = true), (n.response = undefined), (n.mode = undefined), (n.msgQueue = []), (n.isExpired = false), (n.isExecuting = false), (n.isStale = false), (n.isInitialized = false), (n.watchcat.lastAckedSeq = 0), (n.watchcat.seq = 0), n.params.execution === ne.RENDER && (n.msgQueue.push(K.EXECUTE), (n.isExecuted = true), (n.isExecuting = true));
                var c = X(o),
                ...
                var p;
                (a.src = nt(o, n.params.sitekey, n.params, (p = n.rcV) !== null && p !== undefined ? p : W, oe, "b", tt(n))), it(c), n.retryTimeout && window.clearTimeout(n.retryTimeout);
            } else {
        ...
        function T(d) {
            ...
            var p = (o = _.widgetMap.get(n)) === null || o === undefined ? undefined : o.retryTimeout;
        ...
        function S(d, o) {
            ...
            if (h) {
                var l = Object.assign(h, o),
                    ...
                    C = l.sitekey,
                    M;
                l.theme = (M = l.theme) !== null && M !== undefined ? M : Te.AUTO;
                var q;
                l.retry = (q = l.retry) !== null && q !== undefined ? q : se.AUTO;
                var I;
                l.execution = (I = l.execution) !== null && I !== undefined ? I : ne.RENDER;
                var Y;
                l.appearance = (Y = l.appearance) !== null && Y !== undefined ? Y : V.ALWAYS;
                var Z;
                l["retry-interval"] = +((Z = l["retry-interval"]) !== null && Z !== undefined ? Z : Ot);
                var Q;
                l["expiry-interval"] = +((Q = l["expiry-interval"]) !== null && Q !== undefined ? Q : (bt - Et) * 1e3);
                var ee;
                l.size = (ee = l.size) !== null && ee !== undefined ? ee : H.NORMAL;
                var ce = l.callback,
                ...
                var te,
                    $ = (te = l["refresh-expired"]) !== null && te !== undefined ? te : j.AUTO;
                ...
                if (!(!D || !B)) {
                    ...
                    var dt = ["cross-origin-isolated", "fullscreen"],
                        Le;
                    U((Le = (c = document.featurePolicy) === null || c === undefined || (n = c.features) === null || n === undefined ? undefined : n.call(c)) !== null && Le !== undefined ? Le : [], Ke) && dt.push(Ke), N.setAttribute("allow", dt.join("; ")), N.setAttribute("sandbox", "allow-same-origin allow-scripts allow-popups"), (N.id = B);
                    var Pe;
                    (N.tabIndex = (Pe = l.tabindex) !== null && Pe !== undefined ? Pe : 0), (N.title = "Widget containing a Cloudflare security challenge"), a.appendChild(N);
                    var Me,
                        Zt = (Me = l["response-field"]) !== null && Me !== undefined ? Me : true;
                    if (Zt) {
                        var ye = document.createElement("input");
                        ye.type = "hidden";
                        var De;
                        if (((ye.name = (De = l["response-field-name"]) !== null && De !== undefined ? De : It), (ye.id = "".concat(B, "_response")), a.appendChild(ye), typeof l["response-field-name"] != "string" && sr(C))) {
        ...
        function R() {
            var d,
                ...
                a = undefined;
            try {
                for (var p = _.widgetMap[Symbol.iterator](), h; !(n = (h = p.next()).done); n = true) {
                    var l = be(h.value, 2),
                        w = l[0],
                        E = l[1];
                    o < E.idx && ((d = w), (o = E.idx));
        ...
        return {
            ...
            execute: function (o, n) {
                ...
                if (p) {
                    ...
                    if (p.isExecuting) {
                        ...
                        return;
                    } else p.isExecuting = true;
                    if (p.response) {
                        (p.isExecuting = false), x("Call to execute() on a widget that was already executed (".concat(h, "), execute() will return the previous token obtained. Consider using reset() before execute() to obtain a fresh token")), p.cbSuccess && p.cbSuccess(p.response, false);
                        return;
                    }
                    p.isExpired && x("Call to execute on a expired-widget (".concat(h, "), consider using reset() before")), p.isStale && (b(h), (p.isExecuting = true)), p.msgQueue.push(K.EXECUTE), (p.isExecuted = true);
                    var l = document.querySelector("#".concat(h));
                    if (!l) {
                        (p.isExecuting = false), m("Widget ".concat(h, " to execute was not found"), 43522);
                        return;
                    }
                    if (p.isResetting) return;
                    if ((p.isInitialized && y(p, c, l), p.isInitialized && p.params.appearance === V.EXECUTE && ot(l, p), p.isExecuting)) {
                        var w,
                            E = document.querySelector("#".concat(h));
                        if (!E) {
                            m("Received state for an unknown widget: ".concat(c), 3078);
                            return;
                        }
                        (w = E.contentWindow) === null ||
                            w === undefined ||
                            w.postMessage(
                                {
                                    source: P,
            ...
            getResponse: function (o) {
                ...
                if (typeof o == "undefined") {
                    ...
                    if (c) {
                        var a,
                            p = _.widgetMap.get(c);
                        return p != null && p.isExpired && x("Call to getResponse on a widget that expired, consider refreshing the widget."), (a = _.widgetMap.get(c)) === null || a === undefined ? undefined : a.response;
                ...
                return (n = _.widgetMap.get(h)) === null || n === undefined ? undefined : n.response;
            },
            isExpired: function (o) {
                ...
                if (typeof o == "undefined") {
                    ...
                    if (c) {
                        var a, p;
                        return (p = (a = _.widgetMap.get(c)) === null || a === undefined ? undefined : a.isExpired) !== null && p !== undefined ? p : false;
                    } else m("Could not find a widget", 43794);
                }
                var h = v(o);
                if (!h) return m("Could not find widget for provided container", 43778), false;
                var l;
                return (l = (n = _.widgetMap.get(h)) === null || n === undefined ? undefined : n.isExpired) !== null && l !== undefined ? l : false;
            },
        };
    })();
    function fr(e) {
        ...
        function n(E) {
            ...
            return O && window[O] ? window[O] : undefined;
        }
        ...
        var a,
            p = (a = e.getAttribute("data-response-field")) !== null && a !== undefined ? a : "true";
    ...
    var de = false,
        A = Wt(),
        ct;
    _.scriptWasLoadedAsync = (ct = A == null ? undefined : A.loadedAsync) !== null && ct !== undefined ? ct : false;
    A != null &&
        A.params &&
        ((ie = A.params.get("compat")),
        (ie == null ? undefined : ie.toLowerCase()) === "recaptcha" ? (window.grecaptcha ? x("grecaptcha is already defined. The compatibility layer will not be enabled") : (x("Compatibility layer enabled"), (_.isRecaptchaCompatibilityMode = true), (window.grecaptcha = st))) : ie !== null && x('Unknown value for api.js?compat: "'.concat(ie, '", ignoring')),
        A.params.forEach(function (e, r) {
            U(["onload", "compat", "_cb", "_reload", "render"], r) || x('Unknown parameter passed to api.js: "?'.concat(r, '=...", ignoring'));
        }),
        (de = A.params.get("_upgrade") === "true"),
        (z = A.params.get("onload")),
        z &&
            !de &&
            setTimeout(function () {
                typeof window[z] == "function"
                    ? window[z]()
                    : (x("Unable to find onload callback '".concat(z, "' immediately after loading, expected 'function', got '").concat(L(window[z]), "'")),
                      setTimeout(function () {
    ...
    var ie,
        z,
        Yt = "turnstile" in window;
    Yt && !de ? x("Turnstile already has been loaded. Was Turnstile imported multiple times?") : (Yt && de && (Ht(window.turnstile, _), Ze(_, oe), (A == null || (Oe = A.params) === null || Oe === undefined ? undefined : Oe.get("render")) !== "explicit" && setTimeout(ut, 0)), (window.turnstile = st), de || ((A == null || (Ce = A.params) === null || Ce === undefined ? undefined : Ce.get("render")) !== "explicit" && lt.push(ut), document.readyState === "complete" || document.readyState === "interactive" ? setTimeout(jt, 0) : window.addEventListener("DOMContentLoaded", jt)));
    var Oe, Ce;
    function $t() {
        var e = true;
